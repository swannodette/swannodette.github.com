...
A browser window will open. Type a few things at the REPL. Then make a file called whatever you want but ending in `.cljs`. `user.cljs` works if you're not feeling inspired. Again, we're just aimlessly exploring - how does the new proxy functionality in ClojureScript work?
